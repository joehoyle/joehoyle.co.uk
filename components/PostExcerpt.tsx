...
export function PostExcerpt( props: Props ) {
	return (
		<div className={tw`max-w-3xl max-auto p-6 shadow-lg rounded-lg ring-1 ring-gray-200 flex flex-col mb-12`}>
			...
			<a title={`View ${ props.title }`} href={ props.url } className={ tw`inline-flex self-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 hover:bg-gray-50 mt-4 align-center`}>Read More</a>
		</div>
	);
}
